...
. In the *Customization* panel, click the *+* by *Add tag* as shown in the following image:
+
image::add-tag.png[]
...
To delete a tag assigned by property, you must return to the application’s properties file to delete the assignment `anypoint.platform.visualizer.tags=[name]`.

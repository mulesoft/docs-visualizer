...
When you use this property, the nodes automatically show the assigned tags in the *View* card of Anypoint Visualizer. You can add but cannot override tags in the UI; you can modify them only in properties. All letters in tag names are displayed in lowercase.

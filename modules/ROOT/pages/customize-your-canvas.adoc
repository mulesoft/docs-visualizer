...
Anypoint Visualizer supports the use of international characters when you set layer names, tag names, and display names, whether you set them in the UI or using a runtime property.

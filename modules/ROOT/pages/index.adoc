...
* The Troubleshooting visualization, including connection metrics. 
* Hybrid standalone apps are not displayed.
* The topology is shown only for active apps (versus all apps). Active apps are apps that have inbound and outbound traffic within the past seven days.

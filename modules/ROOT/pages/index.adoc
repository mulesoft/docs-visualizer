...
[NOTE]
Anypoint Visualizer currently supports only Mule Applications, APIs, and proxies deployed in CloudHub. For more details about support for on-premises applications, contact your customer success representative.

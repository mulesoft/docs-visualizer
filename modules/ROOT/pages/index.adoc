...
Visualizer supports dedicated load balancers for apps using Mule version 3.9.x or 3.9.x-AM.
While Visualizer doesn't support dedicated load balancers for apps using Mule version 4.1.x and 4.1.x-AM, MuleSoft anticipates that support for Mule version 4.2.

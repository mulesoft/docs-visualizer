...
To access Anypoint Visualizer, you must have have the right permissions. See xref:setup.adoc[Setup Anypoint Visualizer] for information on how to configure permissions.

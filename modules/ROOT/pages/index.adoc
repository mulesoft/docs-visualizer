...
Anypoint Visualizer feature availability depends on the control plane of your Anypoint Platform instance. Data isn’t shared across separate Anypoint Platform instances.

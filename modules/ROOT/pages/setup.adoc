...
[NOTE]
For Runtime Fabric, you must enable the header injection at the application level. +
For a standalone Mule deployment, you must enable the header injection at the server, not application, level. This affects all applications running on the server.

...
To view content in API Visualizer, be assigned a role that has one of the following permissions:
...
When you deploy an app you want to view in API Visualizer, make sure that you select a supported version of Mule as the deployment target. See xref:runtime-manager::index.adoc[Runtime Manager] for more information.

...
=== Verify Supported CloudHub Mule Runtime Engine (Mule)
...
=== Verify Metrics Supported

Anypoint Monitoring metrics are only supported for applications running on these Mule versions:

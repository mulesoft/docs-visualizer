...
. In Runtime Manager, to enable the header injection in the management page,  click *Applications* or *Server* in the menu on the left. 
.. From the list view, select the hybrid app or server for which to enable the header injection, and click *Manage Application* or *Manage Server*. 
. To enable the header injection on the deployment page, click *Deploy application*. 

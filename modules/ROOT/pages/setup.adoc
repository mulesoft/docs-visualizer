...
You must also update the Mule runtime engine for applications using Mule runtime engines that were released before June 30th 2018 to ensure you have the proper Visualizer agent. You can do this with zero downtime for CloudHub applications, APIs, and proxies.
====

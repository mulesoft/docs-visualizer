...
API Visualizer supports the following Mule versions running on CloudHub:
...
API Visualizer supports dedicated load balancers for CloudHub apps using Mule version 3.9.x (version released April 5, 2019 or later).

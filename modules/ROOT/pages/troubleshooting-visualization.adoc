...
[NOTE]
Edges displayed between services are active, meaning that there has been traffic in the past seven days. Nonactive and hybrid app edges do not appear on the canvas.

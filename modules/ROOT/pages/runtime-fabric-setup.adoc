...
Anypoint Visualizer requires an additional header injection for Anypoint Runtime Fabric deployments. However, due to potential performance impact, header injection is disabled by default in Mule 4.x released before <Insert RTF Mule Runtime Date with UA 2.2.2>.
...
Additionally, you will need to use version 1.5.12 or above of the http connector in your mule 4 applications.

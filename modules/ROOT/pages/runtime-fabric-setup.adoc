...
Anypoint Visualizer requires an additional header injection for Runtime Fabric deployments. However, due to a potential performance impact for Mule 4, header injection is disabled by default.

...
For Avg response time, Avg throughput, and Failure rate, you can select *Inbound* or *Outbound* metrics.
...
Metrics are also available for connections, or _edges_, in your network. When you select average response time, average throughput, or failure rate, metrics also appear on applicable connections.

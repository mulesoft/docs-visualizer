...
Use Anypoint Visualizer to view a graph of your application network. The _base unit_ is a Mule application that has been deployed and is running on a supported Mule runtime.
...
. In the drop-down in the canvas, select the visualization you want to use.

...
== Access API Visualizer

. Sign in to Anypoint Platform using an account that has the Visualizer Editor permission.
. Select *API Visualizer* from *Management Center*.

...
[NOTE]
For Canada and Japan control plane deployments, only active apps that have inbound and outbound traffic within the past seven days are shown in the canvas.

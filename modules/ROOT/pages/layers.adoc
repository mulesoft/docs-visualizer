...
Use one of the default layers provided by API Visualizer, or create a custom layer.
...
+
The node appears in the new layer. You can add more nodes to the new layer as necessary.

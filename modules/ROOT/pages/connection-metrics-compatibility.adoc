...
Connection level metrics, or _edge metrics_, are available for many of your connections in the Anypoint Visualizer canvas. Depending on your deployment type (CloudHub, Standalone Mule, or Runtime Fabric), some inbound or outbound metrics do not appear at the connection level.

...
If the source node is a CloudHub app using Mule 4.x, then metrics do not appear on that connection and the following message appears:

`Inbound metrics may be inaccurate or not appear when the source of the connection is a mule app using Mule runtime version 4.x. Learn more.`
...
If the source node is a standalone Mule app using Mule 4 and you have not enabled the additional header injection, then metrics do not appear on that connection and the following message appears:
...
If the source node is a Runtime Fabric app using Mule 4 and you have not enabled the additional header injection, then metrics do not appear on that connection and the following message appears:

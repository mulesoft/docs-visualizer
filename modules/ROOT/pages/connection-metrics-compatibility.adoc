...
Metric is Not Available:: Connections appear if there has been traffic between those services in the past 7 days. If there was no traffic for a particular edge in the time range selected on the *Metric* card, however, metrics will not appear on that edge. This message might appear in the card: `Inbound/Outbound metrics are not available for this connection. Learn more.`
...
`Outbound metrics are not available for this connection. Update the runtime version of the destination Mule app.`

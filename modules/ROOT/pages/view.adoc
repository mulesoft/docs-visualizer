...
Views that you have access to appear in a list in the *Contents* card (click the drop-down arrow to see the list). This gives you easy access to all the views that are available to you, and saves you time because you don't need to readjust filters every time you access Visualizer to get the view that is relevant to you.

== Defined Views

As a Visualizer editor, you can create views that provide a consistent, high quality source of truth for the architecture of each of your organization's projects. Any Visualizer user who has permission for the included environments can see these auto-discoverable views in a drop-down list in the *Contents* card. Only editors can create, rename, and edit defined views.
...
An asterisk appears next to the view name until you click *Save* in the *Contents* card.
. Click *Save*.
...
You can also click *Copy Sharing URL* in the list next to *Save* and send it to the user you want to share the view with.

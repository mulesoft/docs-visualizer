...
In a defined view, you can also select nodes and then hide related services. You can also select nodes and then hide services other than the node that you selected.

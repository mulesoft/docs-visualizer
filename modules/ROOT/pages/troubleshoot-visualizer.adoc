...
=== Why can't I see metadata from an HTTP requester?

To avoid high cardinality, Anypoint Visualizer does not support outbound traffic that uses IP addresses or localhost for validation.
